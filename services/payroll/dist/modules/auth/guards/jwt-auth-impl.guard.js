...
exports.JwtAuthGuardImpl = void 0;
const common_1 = require("@nestjs/common");
const core_1 = require("@nestjs/core");
const passport_1 = require("@nestjs/passport");
const shared_1 = require("@multi-tenant/shared");
let JwtAuthGuardImpl = class JwtAuthGuardImpl extends (0, passport_1.AuthGuard)('jwt') {
...
exports.JwtAuthGuardImpl = JwtAuthGuardImpl;
exports.JwtAuthGuardImpl = JwtAuthGuardImpl = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [core_1.Reflector])
], JwtAuthGuardImpl);
//# sourceMappingURL=jwt-auth-impl.guard.js.map