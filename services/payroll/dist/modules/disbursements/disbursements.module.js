...
const payroll_runs_module_1 = require("../payroll-runs/payroll-runs.module");
...
exports.DisbursementsModule = DisbursementsModule = __decorate([
    (0, common_1.Module)({
        imports: [payroll_runs_module_1.PayrollRunsModule],
        providers: [disbursements_service_1.DisbursementsService],
        exports: [disbursements_service_1.DisbursementsService],
    })
], DisbursementsModule);
