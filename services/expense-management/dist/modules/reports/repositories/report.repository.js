...
let ReportRepository = class ReportRepository {
    ...
    async updateWithLock(id, orgId, data, expectedVersion) {
        const result = await this.repo
            .createQueryBuilder()
            .update(expense_report_entity_1.ExpenseReportEntity)
            .set(data)
...
exports.ReportRepository = ReportRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(expense_report_entity_1.ExpenseReportEntity)),
