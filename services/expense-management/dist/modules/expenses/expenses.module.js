...
exports.ExpensesModule = ExpensesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [expenses_service_1.ExpensesService, expense_repository_1.ExpenseRepository],
        exports: [expenses_service_1.ExpensesService, expense_repository_1.ExpenseRepository],
    })
], ExpensesModule);
